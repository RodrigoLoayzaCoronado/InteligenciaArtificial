...
bluetooth = serial.Serial('COM8', 38400)  # Cambia 'COM8' por el puerto que uses
time.sleep(2)  # Espera para asegurar la conexión

# Crear un entorno personalizado simple de 5x5 con orientación del coche y obstáculos
class SimpleGridEnv(gym.Env):
    def __init__(self):
        ...
        self.obstacles = {2, 7, 8, 13, 18}  # Celdas que son obstáculos
